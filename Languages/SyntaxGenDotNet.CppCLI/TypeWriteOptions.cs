...
internal struct TypeWriteOptions
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether to write the GC tracked pointer operator for the type.
    /// </summary>
    /// <value>
    ///     <see langword="true" /> if the GC tracked pointer operator for the type should be written; otherwise,
    ///     <see langword="false" />.
    /// </value>
    public bool WriteGcTrackedPointer { get; set; } = true;
